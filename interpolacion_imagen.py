...
plt.subplot(221)
plt.imshow(func(grid_x, grid_y), extent=(0,1,0,1))  # Genera la imagen en los puntos del grid
plt.plot(points[:,0], points[:,1], 'k.', ms=1)      # Pinta los puntos de la muestra aleatoria
plt.title('Original')
plt.subplot(222)
